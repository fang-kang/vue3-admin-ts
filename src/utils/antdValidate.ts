 ...
 * 多选
 */
export const NotSelect = (str: any) => {
  return {
    required: true,
    message: `请选择${str}`,
    trigger: 'change',
 ...
 * @param {字符串最大长度} max
 */
export const limitStr = (str: any, min = 3, max = 8) => {
  return {
    required: true,
    min,
    max,
 ...
 * @param {字符串最大长度} max
 */
export const nickStr = (str: any, min = 3, max = 8) => {
  return {
    required: true,
    pattern: /^\w+$/,
    min,
 ...
 */
export const phoneStr = (inlcudeTel: any) => {
